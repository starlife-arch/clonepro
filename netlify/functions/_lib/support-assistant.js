...
- Admin processes withdrawals manually (mark as paid) after user submits request; automatic withdrawals are not offered.
...
SECURITY
- Email OTP plus Withdrawal PIN (6 digits) required for withdrawals, transfers, card payments, and gift coin purchases. OTP expires in 3 minutes and cannot be reused.
...
- "How do I withdraw?" → Go to Withdraw tab, enter amount (min $10), select Bank Transfer, Airtel Money, Sendwave, Remitly, or another active method, provide details, verify email OTP, enter PIN, submit. Admin processes manually; settlement is T+48 hours excluding Saturday, Sunday and Holidays. Bank charges may apply.
