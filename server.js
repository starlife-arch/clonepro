...
import { createDeposit, createWithdrawal, createInvestment, createLoan } from './server-handlers/pg-finance-create.js';
...
app.post('/api/pg/deposits/create', createDeposit);
app.get('/api/pg/withdrawals/:uid', pgWithdrawals);
app.post('/api/pg/withdrawals/create', createWithdrawal);
app.get('/api/pg/investments/:uid', pgInvestments);
app.post('/api/pg/investments/create', createInvestment);
app.get('/api/pg/loans/:uid', pgLoans);
app.post('/api/pg/loans/create', createLoan);
